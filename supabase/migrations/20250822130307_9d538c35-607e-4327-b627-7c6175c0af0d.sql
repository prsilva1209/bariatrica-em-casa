-- Phase 1: Implement Role-Based Access Control and Fix Database Schema (Fixed)
...
-- 9. Add validation constraints (without YouTube validation for now)
...
-- 10. Add URL validation for image_url (allowing both YouTube URLs and IDs for now)
ALTER TABLE public.exercises 
