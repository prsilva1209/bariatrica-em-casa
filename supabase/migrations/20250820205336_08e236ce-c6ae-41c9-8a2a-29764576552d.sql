...
(1, 2, 'Alongamento de Pescoço', 'Alongamento suave para relaxar a região cervical', 5, '1. Incline a cabeça para a direita, segure por 15 segundos. 2. Repita para a esquerda. 3. Incline para frente e para trás. 4. Faça movimentos circulares suaves', 1, 15),
(1, 3, 'Respiração Profunda', 'Exercício de respiração para oxigenação e relaxamento', 8, '1. Inspire pelo nariz por 4 segundos. 2. Segure o ar por 4 segundos. 3. Expire pela boca por 6 segundos. 4. Repita 10 vezes', 1, 20),
(1, 4, 'Elevação de Braços Sentado', 'Exercício suave para ombros e braços', 10, '1. Sente-se com as costas retas. 2. Eleve os braços lateralmente até a altura dos ombros. 3. Abaixe lentamente. 4. Faça 3 séries de 10 repetições', 1, 30),
(1, 5, 'Marcha Estacionária', 'Simulação de caminhada no lugar', 12, '1. Levante alternadamente os joelhos. 2. Balance os braços naturalmente. 3. Mantenha ritmo confortável. 4. Pare se sentir muito cansaço', 1, 40),
...
(2, 2, 'Alongamento de Ombros', 'Relaxamento para região dos ombros', 6, '1. Abraçar o próprio corpo. 2. Alongar um braço sobre o peito. 3. Circular os ombros para trás. 4. Respirar profundamente', 1, 18),
(2, 3, 'Flexão de Braços na Parede', 'Fortalecimento suave do peito e braços', 8, '1. Fique de pé a 60cm da parede. 2. Apoie as palmas na parede. 3. Flexione os braços aproximando o peito da parede. 4. Retorne à posição inicial', 1, 35),
(2, 4, 'Elevação de Pernas Sentado', 'Fortalecimento das pernas', 10, '1. Sente-se com as costas retas. 2. Eleve alternadamente as pernas. 3. Mantenha por 2 segundos no alto. 4. Faça 10 repetições cada perna', 1, 40),
(2, 5, 'Relaxamento Corporal', 'Exercício para relaxar todo o corpo', 8, '1. Deite-se confortavelmente. 2. Contraia e relaxe cada grupo muscular. 3. Comece pelos pés e suba até a cabeça. 4. Respire profundamente', 1, 25);